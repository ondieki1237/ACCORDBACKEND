// Local fallback counties list (Kenya) - used when external KMHFR service is unavailable
// Simple array of county objects { name, code } to keep responses consistent.
export default [
  { code: '1', name: 'Mombasa' },
  { code: '2', name: 'Kwale' },
  { code: '3', name: 'Kilifi' },
