...
export const validateVisit = [
  ...
  body('client.type').notEmpty().withMessage('Client type is required').isIn(['hospital', 'clinic', 'pharmacy', 'lab', 'imaging_center', 'other']).withMessage('Invalid client type'),
  ...
  body('visitPurpose').notEmpty().withMessage('Visit purpose is required').isIn(['demo', 'followup', 'installation', 'maintenance', 'consultation', 'sales', 'complaint', 'other', 'telesales', 'quotation_followup', 'company_introduction', 'debt_collection']).withMessage('Invalid visit purpose'),
